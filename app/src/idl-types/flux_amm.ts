 ...
 * IDL can be found at `target/idl/flux_amm.json`.
 */
export type FluxAmm = {
  "address": "528sS3JkYnhruKWxK4n1mZNJqrVY4qLoRkjmV6D9inVW",
  "metadata": {
    "name": "fluxAmm",
    "version": "0.1.0",
    "spec": "0.1.0",
    "description": "Nexus Protocol — Flux AMM: constant-product swap pool with LP shares and fees."
  },
  "instructions": [
    {
      "name": "addLiquidity",
